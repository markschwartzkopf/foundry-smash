...
let comm1On = document.getElementById('comm1-on');
let comm2On = document.getElementById('comm2-on');
let comm1Level = document.getElementById('comm1-level');
let comm2Level = document.getElementById('comm2-level');
