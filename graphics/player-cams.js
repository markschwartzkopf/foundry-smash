...
const playersRep3 = nodecg.Replicant('players');
const playTypeRep3 = nodecg.Replicant('playType');
const mirrorRep3 = nodecg.Replicant('mirror');
...
function sColor3(num, light) {
    if (!light) {
        return 'var(' + smashColors3[num] + ')';
    }
    else
        return 'var(' + smashColorsLight[num] + ')';
}
...
function setNamesandColors(players, type, mirror) {
